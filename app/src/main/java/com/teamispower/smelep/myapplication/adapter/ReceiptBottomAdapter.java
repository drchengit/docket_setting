 ...
 *  上部，商品列表内容
 */
public class ReceiptBottomAdapter extends RecyclerView.Adapter<ReceiptBottomAdapter.Holder> {
        private Context context;
        private List<KeyData> datas;
        private LayoutInflater inflater;

    public ReceiptBottomAdapter(Context mContext, List<KeyData> topDatas) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = inflater.inflate(R.layout.resale_item_receip_bottom_item,parent,false);
